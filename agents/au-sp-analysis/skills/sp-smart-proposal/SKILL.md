...
description: >-
  Analyzes Smart Proposal MySQL data and proposalState JSON: session usage, funnel,
  ...
  pipeline sources, diff proposals type and conversation details. Read-only MySQL; reply language
...
- 目录对照：`service_and_fee_au_incorp.is_active = 1`
